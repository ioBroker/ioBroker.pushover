/**
 * The ioBroker.pushover blocks for the Blockly editor of ioBroker.javascript.
 *
 ...
 */
import { installGlances } from './blocks/glances';
import { installPushover } from './blocks/pushover';
